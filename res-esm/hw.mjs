...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_myFunction')) {
        Object.defineProperty(Module['ready'], '_myFunction', { configurable: true, get: function() { abort('You are getting _myFunction on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_myFunction', { configurable: true, set: function() { abort('You are setting _myFunction on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
if (Module['locateFile']) {
  ...
  wasmBinaryFile = new URL('hw.wasm', import.meta.url).toString();
}
